...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // MARK: - Background Download Completion Handler
    var backgroundCompletionHandler: (() -> Void)?

    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(handleBackgroundDownloadsFinished),
            name: .backgroundDownloadsFinished,
            object: nil
        )
    ...
    @objc private func handleBackgroundDownloadsFinished() {
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        ...
        */
        let container = NSPersistentCloudKitContainer(name: "DynamicFeatureModule")
